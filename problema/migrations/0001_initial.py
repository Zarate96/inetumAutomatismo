    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo', models.ManyToManyField(related_name='get_elementos', to='problema.Grupo', verbose_name='Elementos')),
        ...
        migrations.AddField(
            model_name='catalogo',
            name='tecnologia',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='get_tecnologia_soc', to='problema.estatus', verbose_name='Tecnología Soc'),
        ),
    ]
