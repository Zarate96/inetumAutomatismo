    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('afectacion', models.CharField(blank=True, choices=[('B2B', 'B2B'), ('B2C', 'B2C'), ('N/A', 'N/A')], max_length=200, null=True, verbose_name='AFECTACIÓN (B2B o B2C)')),
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Fecha de edición')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='get_categoria', to='cambio.categoria', verbose_name='Categoria')),
                ('gerente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='get_gerente_red', to='cambio.gerente', verbose_name='Gerente')),
